...
const prompt = 'create an image of a baby sitting on a couch';

async function generateAndSaveImage(prompt) {
  //try {    
    const response = await openai.images.generate({
       // model: "dall-e-3",// Update with the appropriate model name
      prompt,
      n: 1
    });
    ...
    await downloadImage(imageUrl, 'public/img/response.jpg');
